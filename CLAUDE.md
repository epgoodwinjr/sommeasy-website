...
3. Auth overhaul Session 4 (`docs/auth-overhaul-brief.md` — hardening/watchtower: fetch-menu SSRF, auth-route rate limits, stub-client build assertion, observability)
